...
function nullable(wrapped, ...args2) {
  const schema = {
    kind: "schema",
    type: "nullable",
    reference: nullable,
...
function nullableAsync(wrapped, ...args2) {
  const schema = {
    kind: "schema",
    type: "nullable",
...
function nullish(wrapped, ...args2) {
  const schema = {
    kind: "schema",
    type: "nullish",
    reference: nullish,
...
function nullishAsync(wrapped, ...args2) {
  const schema = {
    kind: "schema",
    type: "nullish",
...
function optionalAsync(wrapped, ...args2) {
  const schema = {
    kind: "schema",
    type: "optional",
...
function undefinedable(wrapped, ...args2) {
  const schema = {
    kind: "schema",
    type: "undefinedable",
...
function undefinedableAsync(wrapped, ...args2) {
  const schema = {
    kind: "schema",
    type: "undefinedable",
