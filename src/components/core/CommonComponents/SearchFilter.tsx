  ...
  return (
    <div className="relative h-[35px] w-[170px]">
      ...
      <Input
        ...
        className="pl-8 pr-8 bg-[#FFFFFF] border-[#E2E2E2] rounded-[8px] w-full h-[35px] placeholder:text-[#00000099] placeholder:max-w-[180px] overflow-hidden overflow-ellipsis whitespace-nowrap focus:outline-none focus-visible:outline-none"
      />
      {searchString && (
        <button
