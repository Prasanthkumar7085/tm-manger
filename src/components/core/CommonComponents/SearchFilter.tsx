...
const SearchFilter: React.FC<IReportsFilters> = ({
  ...
  return (
    <div className="relative h-[35px] w-[215px]">
      ...
      <Input
        ...
        className="pl-8 pr-8 bg-[#FFFFFF] border-[#E2E2E2] rounded-[8px] w-full h-[35px] placeholder:text-[#00000099] focus:outline-none focus-visible:outline-none"
      />
      {searchString && (
        <button
