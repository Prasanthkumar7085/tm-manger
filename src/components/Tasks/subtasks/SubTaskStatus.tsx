...
function SubTaskStatus({
  ...
  const updateTaskStatus = async (status: string) => {
    ...
    try {
      ...
      const response = await statusUpdateAPI(subTaskId, body);
  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      <button
        ...
        className={`text-md px-2 h-[25px] border  font-normal rounded-[4px] flex items-center max-w-[140px] justify-between ${
